    ...
    <div className="experimental-container">
      ...
      <div className="interface">
        ...
        <div className="journey-container">
          ...
          {/* Hidden drawer that reveals on hover */}
          <div className="hidden-drawer">
            <div className="drawer-handle">✨</div>
            <div className="drawer-content">
              <p>🎂 Você está convidado para uma experiência imersiva</p>
              <p>🗺️ Cada elemento é uma porta para algo especial</p>
              <p>🔮 Gire o menu radial para desbloquear ações</p>
            </div>
          </div>
